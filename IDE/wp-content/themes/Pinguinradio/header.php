...
<head id="www.pinguinradio.com">
	...
	<meta property="og:title" content="Pinguin Radio" />
	<meta property="og:type" content="radio.music" />
	<meta property="og:url" content="http://www.pinguinradio.com" />
	...
	<link rel="stylesheet" href="/_assets/css/style.css?1.9">
    ...
    <?php 
	//check of de url de vriendenpagina is, zo ja dan wphead inladen voor het formulier.
		$host = $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
        if($host == 'pinguinradio.com/acties/vrienden-van-pinguin/') 
            {
                wp_head();
            }
                else
	...
	<script type="text/javascript">
		...
		var AAPL_ignore_string = new String('#, /wp-, /shop, /pinguin-radio-top-150-aller-tijden, /top-van-de-ijsberg, /acties/vrienden-van-pinguin, /acties/vrienden-van-pinguin/, /backstage/2-minuten-show, .pdf, .zip, .rar, ignore'); 
...
<?php 
//RANDOM BACKGROUND 
      $bg = array('001.jpg', '002.jpg', '003.jpg', '004.jpg', '005.jpg', '006.jpg', '007.jpg' ); // array of filenames
...
<style type="text/css">
    <!--
    body{
    background: url(/_assets/img/global/layout/backgrounds/<?php echo $selectedBg; ?>) no-repeat center center fixed; 
